...
class TrainSVM():
    ...
    def __init__(self):
        ...
        # data type
        self.datatype = ["stay","tran","over"]
        # labels 
        self.labels = {"stay":0,"tran":1,"over":2}
    ...
    def predict(self,input_sample):
        ...
        input_sample = input_sample.reshape((1,30*54))
        # preparing the model 
    ...
    def saveModel(self):
        filename = "model/svm_nonlinear.pkl"
